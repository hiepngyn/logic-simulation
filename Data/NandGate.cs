...
{
    /// <summary>
    /// Class representing an NAND Gate object.
    /// </summary>
    public class NandGate : INotifyPropertyChanged
    {
        /// <summary>
        /// Name of the gate.
        /// </summary>
        public string Name = "NAND Gate";
        ...
        public bool OutputValue
        {
            get
            {
                if ((TopInput == true) && (BottomInput == true)) return false;
                else return true;
            }
        }
